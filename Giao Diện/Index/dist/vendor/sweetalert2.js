! function(t, e) {
    ...
    It.text = It.email = It.password = It.number = It.tel = It.url = function(t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : b(e.inputValue) || z('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), St(t, e), t.type = e.input, t
    ...
    var Ut = function() {
        ...
        Wt = [],
        Kt = function(t, e) {
            t.className = "".concat(Q.popup, " ").concat(bt(t) ? e.showClass.popup : ""), e.toast ? (gt([document.documentElement, document.body], Q["toast-shown"]), gt(t, Q.toast)) : gt(t, Q.modal), _(t, e, "popup"), "string" == typeof e.customClass && gt(t, e.customClass), e.icon && gt(t, Q["icon-".concat(e.icon)])
        };
    ...
    function Gt(t) {
        for (var e in t) Jt(i = e) || z('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== ie.indexOf(o) && z('The parameter "'.concat(o, '" is incompatible with toasts'))), Xt(n = e) && g(n, Xt(n));
        var n, o, i
    }
    var te = {},
        ee = {
        ...
        re = Object.freeze({
            ...
            queue: function(t) {
                ...
                return new Promise(function(i) {
                    ! function e(n, o) {
                        n < Wt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(Wt[n]).then(function(t) {
    ...
    function he(t) {
        ...
        }(t), (e = Et.innerParams.get(this)) && !U(i, e.hideClass.popup) && (n = fe.swalPromiseResolve.get(this), vt(i, e.showClass.popup), gt(i, e.hideClass.popup), o = J(), vt(o, e.showClass.backdrop), gt(o, e.hideClass.backdrop), function(t, e, n) {
            var o = J(),
                i = xt && ut(e),
                r = n.onClose,
                a = n.onAfterClose;
    ...
    var ge = function(t, e, n, o) {
            te.swalCloseEventFinishedCallback = me.bind(null, t, n, G(), o), e.addEventListener(xt, function(t) {
    ...
    function ke(t) {
        var e, n;
        (e = t).inputValidator || Object.keys(Ce).forEach(function(t) {
    ...
    function Be(t) {
        ...
        Me(e, n, t), qe(e, n), H() && (Ie(e, t.scrollbarPadding, o), h(document.body.children).forEach(function(t) {
            t === J() || function(t, e) {
        ...
        })), G() || te.previousActiveElement || (te.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() {
            return t.onOpen(n)
    ...
    function Pe(t, e) {
        "select" === e.input || "radio" === e.input ? Re(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && (v(e.inputValue) || b(e.inputValue)) && Ne(t, e)
    }
    ...
    var qe = function(t, e) {
        ...
        Ie = function(t, e, n) {
            var o;
            (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !U(document.body, Q.iosfix) && (o = document.body.scrollTop, document.body.style.top = "".concat(-1 * o, "px"), gt(document.body, Q.iosfix), de(), le()), "undefined" != typeof window && se() && (ue(), window.addEventListener("resize", ue)), e && "hidden" !== n && ce(), setTimeout(function() {
                t.scrollTop = 0
            })
        },
        Me = function(t, e, n) {
            gt(t, n.showClass.backdrop), rt(e), gt(e, n.showClass.popup), gt([document.documentElement, document.body], Q.shown), n.heightAuto && n.backdrop && !n.toast && gt([document.documentElement, document.body], Q["height-auto"])
        },
        Ve = function(t) {
        ...
        Re = function(e, n) {
            ...
            var i = x();
            v(n.inputOptions) || b(n.inputOptions) ? (Yt(), y(n.inputOptions).then(function(t) {
                e.hideLoading(), o(t)
        ...
        Fe = function(e, n) {
            ...
            })) : e.getInput().checkValidity() ? We(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        },
        ze = function(t) {
            t.closePopup({
                isDenied: !0,
        ...
        We = function(e, t, n) {
            t.showLoaderOnConfirm && Yt(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve().then(function() {
        ...
        Xe = function(t) {
            var e, n; - 1 !== [E(), O(), L()].indexOf(document.activeElement) && (e = -1 !== Ke.indexOf(t) ? "nextElementSibling" : "previousElementSibling", (n = document.activeElement[e]) && n.focus())
        },
        Ge = function(t, e, n) {
    ...
    var an = function(t, e, n) {
            var o = M();
            at(o), e.timer && (t.timeout = new we(function() {
        ...
        pn = Object.freeze({
            ...
            update: function(e) {
                ...
                Object.keys(e).forEach(function(t) {
                    mn.isUpdatableParameter(t) ? o[t] = e[t] : z('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
                });
                var i = s({}, n, o);
                Rt(this, i), Et.innerParams.set(this, i), Object.defineProperties(this, {
                    params: {
    ...
    s(fn.prototype, pn), s(fn, re), Object.keys(pn).forEach(function(t) {
        fn[t] = function() {
            if (ln) return ln[t].apply(ln, arguments)
        }
    }), fn.DismissReason = Z, fn.version = "10.0.2";
    var mn = fn;
